...
const MovieCard = ({ title,posterPath,voteCount,voteAvg,releaseDate }) => {
  ...
  return (
    <div
      ...
      className=" flex flex-col shadow-md border border-gray-200 rounded-lg h-128 xl:w-64 mx-1 dark:bg-gray-800 dark:border-gray-700"
    >
      <img
      ...
      <div className=" flex-end pt-8 mx-2 text-lg text-white flex flex-row justify-between">
